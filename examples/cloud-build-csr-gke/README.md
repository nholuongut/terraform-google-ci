...
1. If you haven't already, clone this repo:
   - `$ git clone https://github.com/nholuongut/terraform-google-ci.git`
...
example, we have prepared a [sample GitHub repository](https://github.com/nholuongut/docker-for-devops) with a
...
1. Clone the `sample-app-docker` repo to an empty directory outside of this example:
   - `$ git clone https://github.com/nholuongut/docker-for-devops.git`
...
the Cloud Build service account is `https://github.com/nholuongut/terraform-google-ci`. When you enable the Cloud Build API, the service
