...
resource "google_cloudbuild_trigger" "cloud_build_trigger" {
  ...
  # See: https://github.com/nholuongut/docker-for-devops/blob/main/cloudbuild.yaml#L40
  substitutions = {
...
module "gcr_registry" {
  ...
  # source = "github.com/nholuongut/terraform-google-ci.git//modules/gcr-registry?ref=v0.1.0"
...
module "gke_cluster" {
  ...
  source = "git::git@github.com:nholuongut/terraform-google-gke.git//modules/gke-cluster?ref=v0.3.8"
  ...
  # When creating a private cluster, the 'main_ipv4_cidr_block' has to be defined and the size must be /28
  main_ipv4_cidr_block = var.main_ipv4_cidr_block
  ...
  # With a private cluster, it is highly recommended to restrict access to the cluster main
...
module "gke_service_account" {
  source = "git::git@github.com:nholuongut/terraform-google-gke.git//modules/gke-service-account?ref=v0.3.8"
...
module "vpc_network" {
  source = "github.com/nholuongut/terraform-google-network.git//modules/vpc-network?ref=v0.2.1"
